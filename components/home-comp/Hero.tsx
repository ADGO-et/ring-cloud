...
export default function Hero() {
  return (
    <div className=" w-full h-full bg-gradient-to-b from-black via-black to-white">
      <div className="bg-hero-bg bg-center bg-cover items-center flex flex-col justify-center space-y-6 text-white md:px-28 px-4 py-16 lg:bg-bottom lg:h-[100vh] lg:space-y-6 lg:my-5 pb-5 shadow-none">
        ...
        <Link className="bg-white text-black w-fit px-8 py-2 rounded-lg text-xl hover:text-white hover:bg-primaryColor" href='/services'>
          Order
        </Link>
