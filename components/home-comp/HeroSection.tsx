        ...
        <div className="relatve md:w-3/5 lg:px-12">
          <RotateWrapper direction="vertical">
            <FadeIn className="text-3xl md:text-4xl font-bold text-gray-900">
              Empower Your Communications <br/>with Ringcloud
            </FadeIn>
          </RotateWrapper>
          <FadeIn className="mt-4 text-gray-600 text-lg">
            At Ringcloud, we believe in simplifying and elevating the way businesses connect. <br/> Our
            state-of-the-art communication solutions help you stay agile, secure <br/>,and efficient—no
